...
import { getFlashcardById } from 'apiSdk/flashcards';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('flashcard', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/flashcards/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              {hasAccess('flashcard_deck', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/flashcard-decks/view/${data?.flashcard_deck?.id}`}>
                      {data?.flashcard_deck?.title}
                    </Link>
                  </Text>
                </Flex>
              )}
